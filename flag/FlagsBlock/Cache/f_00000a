...
Blockly.Blocks['math_single'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      //"output": [Blockly.Types.NUMBER.output, Blockly.Types.DECIMAL.output],
...
Blockly.Blocks['math_change2'] = {
  ...
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.MATH_CHANGE2_TITLE,
      "args0": [
        {
          "type": "field_variable",
          "name": "VAR",
        ...
        },
        {
          ...
          "name": "OP",
          "options": [
            [ Blockly.Msg.MATH_CHANGE2_ADD, "+" ],
            [ Blockly.Msg.MATH_CHANGE2_SUBTRACT, "-" ],
            [ Blockly.Msg.MATH_CHANGE2_MULTIPLY, "*" ],
            [ Blockly.Msg.MATH_CHANGE2_DIVIDE, "/" ],
          ]
        },
        {
          "type": "input_value",
...
Blockly.Blocks['math_statistics'] = {
  init: function() {
    ...
    this.updateShape_();
    this.setOutput(true, Blockly.Types.NUMBER.output);
    this.setMutator(new Blockly.Mutator(['math_statistics_join_item']));
    this.setTooltip('');
  },
  /**
  ...
  decompose: function(workspace) {
    var containerBlock = workspace.newBlock('math_statistics_join_container');
    containerBlock.initSvg();
    var connection = containerBlock.getInput('STACK').connection;
    for (var i = 0; i < this.itemCount_; i++) {
      var itemBlock = workspace.newBlock('math_statistics_join_item');
      itemBlock.initSvg();
  ...
  updateShape_: function() {
    ...
    for (var i = 0; i < this.itemCount_; i++) {
      if (!this.getInput('ADD' + i)) {
        ...
        if (i == 0) {
          var OPERATORS =
              [[Blockly.Msg.MATH_STATISTICS_OPERATOR_AVERAGE, 'AVERAGE'],
               [Blockly.Msg.MATH_STATISTICS_OPERATOR_SUM, 'SUM'],
               [Blockly.Msg.MATH_STATISTICS_OPERATOR_MAX, 'MAX'],
               [Blockly.Msg.MATH_STATISTICS_OPERATOR_MIN, 'MIN'],
              ];
          // Assign 'this' to a variable for use in the closures below.
          var thisBlock = this;
          var dropdown = new Blockly.FieldDropdown(OPERATORS, function(newOp) {
  ...
  updateType_: function(newOp) {
    switch (newOp) {
      case "AVERAGE":
          this.myType_ = Blockly.Types.DECIMAL;
          break; 
      case "SUM":
          this.myType_ = Blockly.Types.LARGE_NUMBER;
          break; 
      default: 
          this.myType_ = Blockly.Types.NUMBER;
    }
  },

  myType_ : Blockly.Types.NUMBER,
...
Blockly.Blocks['math_statistics_join_container'] = {
  /**
...
Blockly.Blocks['math_statistics_join_item'] = {
  /**

...
Blockly.Arduino.Boards.profiles.nodemcu = {
  name: 'NodeMCU',
  description: 'NodeMCU ESP8266 board',
  compilerFlag: 'esp8266com:esp8266:nodemcuv2:CpuFrequency=80,FlashSize=4M1M,LwIPVariant=open,Debug=Disabled,DebugLevel=None____,UploadSpeed=115200',
  analogPins: [['A0', 'A0']],
  digitalPins: [['D0', 'D0'], ['D1', 'D1'], ['D2', 'D2'], ['D3', 'D3'], ['D4', 'D4'], 
                ['D5', 'D5'], ['D6', 'D6'], ['D7', 'D7'], ['D8', 'D8']],
  pwmPins: [['D0', 'D0'], ['D1', 'D1'], ['D2', 'D2'], ['D3', 'D3'], ['D4', 'D4'], 
            ['D5', 'D5'], ['D6', 'D6'], ['D7', 'D7'], ['D8', 'D8']],
  serial: [['serial', 'Serial']],
  serialPins: { Serial: [['RX', 'RX'], ['TX', 'TX']] },
  serialSpeed: Blockly.Arduino.Boards.profiles.uno.serialSpeed,
  ...
  interrupt: [['D1', 'D1'], ['D2', 'D2'], ['D3', 'D3'], ['D4', 'D4'], 
              ['D5', 'D5'], ['D6', 'D6'], ['D7', 'D7'], ['D8', 'D8']]
};

/** ESP8266 for the Wemos D1 R2. */
Blockly.Arduino.Boards.profiles.wemos_d1_mini = {
  name: 'WeMos D1 mini',
  description: 'Wemos D1 R2 compatible board',
  compilerFlag: 'esp8266com:esp8266:d1_mini:CpuFrequency=80,FlashSize=4M1M,LwIPVariant=open,Debug=Disabled,DebugLevel=None____,UploadSpeed=921600',
  analogPins: [['A0', 'A0']],
  digitalPins: [['D0', 'D0'], ['D1', 'D1'], ['D2', 'D2'], ['D3', 'D3'], ['D4', 'D4'], 
                ['D5', 'D5'], ['D6', 'D6'], ['D7', 'D7'], ['D8', 'D8']],
  pwmPins: [['D0', 'D0'], ['D1', 'D1'], ['D2', 'D2'], ['D3', 'D3'], ['D4', 'D4'], 
...
Blockly.Arduino.Boards.refreshBlockFieldDropdown =
  ...
  if (!currentValuePresent) {
    block.setWarningText(
         Blockly.Msg.REFRESHBLOCKFIELDDROPDOWN_WARNING.replace('%1',fieldValue), 'bPin');
  } else {

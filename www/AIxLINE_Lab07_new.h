...
<body>
 ...
 function addFace(){
  ...
  $.ajax({
   url: apiLocation + "face/v1.0/persongroups/"+groupID+"/persons/"+personId+"/persistedFaces",
 ...
 function identPerson() {
  ...
  $.ajax({
   url: apiLocation + "face/v1.0/detect?" + $.param(params),
   beforeSend: function(xhrObj){
    xhrObj.setRequestHeader("Content-Type","application/octet-stream");
    xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key",apiKey);
   },
  ...
  .done(function(data) {
   if (data.length == 0) {
    ...
    $.ajax({
     url: apiLocation + "face/v1.0/identify",
     beforeSend: function(xhrObj){
      xhrObj.setRequestHeader("Content-Type","application/json");
      xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key",apiKey);
     },
 ...
 function trainGroup() {
  $.ajax({
   url: apiLocation + "face/v1.0/persongroups/"+groupID+"/train?",
   beforeSend: function(xhrObj){
    xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key",apiKey);
   },
   type: "POST",
 ...
 function checkTraining() {
  $.ajax({
   url: apiLocation + "face/v1.0/persongroups/"+groupID+"/training",
   beforeSend: function(xhrObj){
    xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key",apiKey);
   },
   type: "GET",
 ...
 function delPerson() {
  ...
  if (id) {
   $.ajax({
    url: apiLocation + "face/v1.0/persongroups/"+groupID+"/persons/" + id,
    beforeSend: function(xhrObj){
     xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key",apiKey);
    },
    type: "DELETE",
 ...
 function addPerson() {
  ...
  if (name) {
   $.ajax({
    url: apiLocation + "face/v1.0/persongroups/"+groupID+"/persons",
    beforeSend: function(xhrObj){
     xhrObj.setRequestHeader("Content-Type","application/json");
     xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key",apiKey);
    },
 ...
 function addGroup(id) {
  $.ajax({
   type: "PUT",
   url: apiLocation + "face/v1.0/persongroups/"+id,
   beforeSend: function(xhrObj){
    xhrObj.setRequestHeader("Content-Type","application/json");
    xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key",apiKey);
   },
 ...
 function checkGroup(id) {
  $.ajax({
   type: "GET",
   url: apiLocation + "face/v1.0/persongroups",
   beforeSend: function(xhrObj){
    xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key",apiKey);
   },
   dataType: "json",

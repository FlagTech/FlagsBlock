...
Blockly.Blocks['serial_print'] = {
  ...
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.ARD_SERIAL_PRINT_MSG,
      "args0": [
        {
          "type": "field_dropdown", 
          "name": "SERIAL_ID", 
      ...
      "tooltip": Blockly.Msg.ARD_SERIAL_PRINT_TIP,
...
Blockly.Blocks['serial_read'] = {
  ...
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.ARD_SERIAL_READ_MSG,
      "args0": [
        {
          "type": "field_dropdown", 
          "name": "SERIAL_ID", 
      ...
      "colour": Blockly.Blocks.serial.HUE,
      "tooltip": Blockly.Msg.ARD_SERIAL_READ_TIP,
      "helpUrl": 'https://www.arduino.cc/en/Reference/SoftwareSerialAvailable'
    }); 
  },
  /** @return {!string} Type of the block, text length always an integer. */

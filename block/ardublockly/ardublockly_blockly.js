...
Ardublockly.bindBlocklyEventListeners = function() {
  Ardublockly.workspace.addChangeListener(workspaceChangeHandler);
...
Ardublockly.loadSessionStorageBlocks = function() {
  ...
  try {
    ...
    flagsBlockProjectDir = window.sessionStorage.flagsBlockProjectDir;
    flagsBlockProjectFileName = window.sessionStorage.flagsBlockProjectFileName;
    flagsBlockProjectIsChanged = window.sessionStorage.flagsBlockProjectIsChanged;
  } catch (e) {
...
Ardublockly.discardAllBlocks = function(event, callback) {
